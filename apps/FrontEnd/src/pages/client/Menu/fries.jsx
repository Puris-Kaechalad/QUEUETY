            ...
            <div className="flex">
                ...
                <div className="content w-full py-32">
                    <div className="card-box py-4 flex justify-center flex-wrap gap-8 tracking-widest text-lg font-semibold">
                        {/* ตรวจสอบว่า menus.Fries เป็น Object และมีข้อมูล */}
                        {menus.Fries && Object.keys(menus.Fries).length > 0 ? (
                            // ใช้ Object.values() เพื่อดึงข้อมูลเมนูจาก Object
                            Object.values(menus.Fries).map((item, index) => (
                            ...
                            <p>No items available for Fries</p> 
                        )}
                    </div>
                </div>
            </div>
